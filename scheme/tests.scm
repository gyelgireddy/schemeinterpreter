...
(begin (define s 10) (cons s '(x 7 2)))
;expect (10 x 7 2)
...
;cube
(define (difference-of-cube x y) (+ (cube x) (cube y)))
;difference-of-cube
(difference-of-cube 10 5)
;expect 1125
